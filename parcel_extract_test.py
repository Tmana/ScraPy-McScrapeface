...
file = 'C:/Users/trobart/Desktop/Deeds/final_deed_data/parcel_test/parcel_test{0}.csv'.format(inputs)
output = open(file, 'w')
		...
		with tqdm(total = num_lines) as pbar:
			...
			for line in file:
				...
				if "inst. number" in line.lower() or (("number" in line.lower() and "book" in line.lower() and "page" in line.lower() ) or ("bk" in line.lower() and "pg" in line.lower() and "number" in line.lower()) or 'instrument#' in line.lower()):
					...
					############################
					output.write(instrument_num + ',' + date + ',' + cleaned_parcel + ',' + clean_consideration + ',' + deed_type + '\n')
					total_count += 1
